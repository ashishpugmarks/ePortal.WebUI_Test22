...
{
    /// <summary>
    /// CLASS FOR DATA ACCESS LAYER GIVES DATA DIRECTLY FORM DATABASE
    /// </summary>
    public class DataManagement
    {
        ...
        private readonly ConnectionString objCnStr;
        public DataManagement(ConnectionString _objCnStr)
        {
            objCnStr = _objCnStr;
        }
