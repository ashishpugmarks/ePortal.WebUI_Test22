...
namespace ePortal.WebUI.Controllers
{
    public class AdminBaseController : Controller
    {
        ...
        public AdminBaseController(IDataManagement _oDataMgmt, IConnectionString _objCnStr, ILogger<AdminBaseController> logger, IConfiguration settings, ISessionService sessionService)
        {
        ...
        protected void LoadMenu(string strUserCode)
        {
            try
            {
                ...
                xAdminslt.Load(Path.Combine(serverpath.getFileUploadPath(), "Includes", "Xslt", "AdminMenuXSLT.xsl"));
