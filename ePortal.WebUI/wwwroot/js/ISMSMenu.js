...
$(document).ready(function () {
    {
        $.ajax({
            type: "GET",
            //url: "ISMSPAGE.Master/GetTextSearch",
            url: "/ISMS/GetMenu",
            dataType: "json",
            cache: false,
            success: function (data) {
                ...
                //var res1val = data.ISMSSubInfoMenuItems;
                var mainmenu = res1.filter(function (entry) { return entry.MenuParentId === 0 && entry.MenuLevel === 1 })
                var innerHTML1 = "";
                innerHTML1 += '<div class="col-sm-2 search_menu pull-right"><input class="search_input" id="txtMenuSearch" placeholder="Search for Menu" /><i onclick="resetSearchText();" class="clearable__clear">&times;</i></div>';
                ...
                $.each(mainmenu, function (i, item) {
                    ...
                    if (var1.length == 0) {
                        ...
                        if (item.MenuParentId == 0) {
                            debugger;
                            var url_title1 = item.URL == "" ? "#" : item.URL;
        ...
        //{
        //    debugger;
        //    window.location.href = "pdfview.aspx?f=" + url;
        //}
    }
});
