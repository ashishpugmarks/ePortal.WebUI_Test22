...
function loadVendorRequests() {
    ...
    $.ajax({
        url: '/VendorMaster/GetVendorBlockApprovalRequest',
        type: 'POST',
        data: filter,
...
function bindTable(items) {
    ...
    $.each(items, function (i, item) {
        ...
        <tr>
            ...
            //           </a>`
            `<a href="/VendorMaster/VendorBlockApprovalForm?VMID=${item.EncryptedVendorHeaderId}" title="Block Approval Request">
                       <i class="fa fa-edit text-warning"></i>
                   </a>`
                : ''}
            </td>
