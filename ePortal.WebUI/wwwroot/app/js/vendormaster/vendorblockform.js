...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function submitVendorBlock() {
        ...
        $.ajax({
            url: '/VendorMaster/SubmitVendorBlock',
            type: 'POST',
    ...
    $('#btncancelfrm').on('click', function () {
        window.location.href = window.location.origin + "/VendorMaster/VendorBlockForm";
    });
    ...
    btnSubmit && btnSubmit.addEventListener('click', submitVendorBlock);
